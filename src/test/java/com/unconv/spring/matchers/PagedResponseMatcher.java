...
public class PagedResponseMatcher {
    public static ResultMatcher pagedResponse(
            int dataSize, int defaultPageSize, int totalPages, boolean isFirstPage) {
        return result -> {
