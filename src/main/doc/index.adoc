...
=== Humidity Threshold
    ...
    The HumidityThreshold class represents a humidity threshold encapsulating information about theminimum and maximum values for humidity values.

include::entity/humidityThreshold.adoc[]

=== Temperature Threshold

    The TemperatureThreshold class represents a humidity threshold encapsulating information about theminimum and maximum values for temperature values.
...
=== Humidity Threshold
include::api/HumidityThreshold/api.adoc[]

=== Temperature Threshold
include::api/TemperatureThreshold/api.adoc[]

=== SensorLocation
include::api/SensorLocation/api.adoc[]
